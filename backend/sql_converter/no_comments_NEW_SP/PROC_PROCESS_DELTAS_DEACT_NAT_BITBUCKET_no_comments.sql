REPLACE PROCEDURE DG_I_P_30INF_CBCI.PROC_PROCESS_DELTAS_DEACT_NAT(IN par_COG_RUN_ID INTEGER, IN par_ETL_RUN_ID INTEGER, IN par_PROC_NR INTEGER, OUT par_Status INTEGER)
BEGIN
