...
BEGIN
	...
	BEGIN
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_msg_spec("SENDINGENTITYIN", "SENDINGENTITYNAME", "TRANSMITTINGCOUNTRY",					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_repo_ent("MESSAGEREFID", "SENDINGENTITYIN", "TRANSMITTINGCOUNTRY", REPORTINGPERIOD, 					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_repo_ent_in("REPORTINGENTITYTIN", "CBCBODYID", "DOCREFID", "CORRDOCREFID",					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_repo_ent_name("REPORTINGENTITYTIN", "CBCBODYID", "DOCREFID", "CORRDOCREFID",					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_repo_ent_adrs ("REPORTINGENTITYTIN", "CBCBODYID", "DOCREFID", "CORRDOCREFID",					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_repo_ent_res_cntry ("REPORTINGENTITYTIN", "CBCBODYID", "DOCREFID", "CORRDOCREFID",					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_cbcrepos_sum("MESSAGEREFID", "SENDINGENTITYIN", "TRANSMITTINGCOUNTRY", REPORTINGPERIOD, "REPORTINGENTITYTIN", 					
		...
		(SELECT DISTINCT MESSAGEREFID, SENDINGENTITYIN, TRANSMITTINGCOUNTRY, REPORTINGENTITYTIN, CBCBODYID, DOCREFID, CORRDOCREFID, ETL_RUN_ID, X_OP_TYPE
		 	FROM DG_I_O_40ANA_CBC.StCBCN_cbcrepos_cnst_ents WHERE ETL_RUN_ID > par_ERI_PROC AND X_OP_TYPE = 'D' ) AS S,
		DG_I_O_40ANA_CBC.DpCBCD_msg_spec AS M,
		(SELECT DISTINCT MESSAGEREFID,  TRANSMITTINGCOUNTRY, REPORTINGENTITYTIN, DOCREFID, CORRDOCREFID, CBCBODYID, ETL_RUN_ID
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_cnst_ent_res_cntry("REPORTINGENTITYTIN", "CBCBODYID", "CBCREPORTID", 					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_cnst_ent_biz_acts("REPORTINGENTITYTIN", "CBCBODYID", "CBCREPORTID", 					
		...
		(SELECT DISTINCT MESSAGEREFID, SENDINGENTITYIN, TRANSMITTINGCOUNTRY, REPORTINGENTITYTIN, CBCBODYID, DOCREFID, CORRDOCREFID, ETL_RUN_ID, X_OP_TYPE
		 	FROM DG_I_O_40ANA_CBC.StCBCN_cbcrepos_cnst_ents WHERE ETL_RUN_ID > par_ERI_PROC AND X_OP_TYPE = 'D' ) AS S,
		DG_I_O_40ANA_CBC.DpCBCD_msg_spec AS M,
		(SELECT DISTINCT MESSAGEREFID,  TRANSMITTINGCOUNTRY, REPORTINGENTITYTIN, CBCBODYID, DOCREFID, CORRDOCREFID, ETL_RUN_ID
		 	FROM DG_I_O_40ANA_CBC.DpCBCD_cbcrepos_cnst_ents) AS P
		SET END_DATE = M.X_ONTVANGSTDATUMTIJD - INTERVAL '1' SECOND
		, CURRENT_FLAG = 'N'
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_cnst_ent_adrs("REPORTINGENTITYTIN", "CBCBODYID", "CBCREPORTID", 					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_cnst_ent_name("REPORTINGENTITYTIN", "CBCBODYID", "CBCREPORTID", 					
		...
		(SELECT DISTINCT ETL_RUN_ID, CBCBODYID, TRANSMITTINGCOUNTRY, SENDINGENTITYIN, REPORTINGENTITYTIN, MESSAGEREFID, CORRDOCREFID
			...
			WHERE X_OP_TYPE = 'D' AND ETL_RUN_ID > par_ERI_PROC)  AS S,					
		DG_I_O_40ANA_CBC.DpCBCD_msg_spec AS P
		SET END_DATE = P.X_ONTVANGSTDATUMTIJD - INTERVAL '1' SECOND
		, CURRENT_FLAG = 'N'
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_add_info_res_cntry("REPORTINGENTITYTIN", "CBCBODYID",  "ADINFOID", "DOCREFID", 					
		...
		INSERT INTO DG_I_O_40ANA_CBC.DpCBCD_add_info_sum_ref("REPORTINGENTITYTIN", "CBCBODYID",  "ADINFOID", "DOCREFID", 					
