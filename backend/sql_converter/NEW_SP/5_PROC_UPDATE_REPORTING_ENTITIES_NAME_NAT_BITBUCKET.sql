	REPLACE PROCEDURE DG_I_P_30INF_CBCI.PROC_UPDATE_REPORTING_ENTITIES_NAME_NAT(IN par_COG_RUN_ID INTEGER, IN par_ETL_RUN_ID INTEGER, IN par_PROC_NR INTEGER, IN par_TABLE_NAME VARCHAR(40), OUT par_Status INTEGER)
	BEGIN
